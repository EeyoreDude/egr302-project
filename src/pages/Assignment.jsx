                ...
                <div className="container">
                    <div className="row align-items-center my-5">
                        <div className="col-lg-10">
                            ...
                            <div className="ml-3 ">
                                <h5 className="font-italic mb-4 mt-3">{event.description}</h5>
                                <p>{event.complete ? 'This assignment has been turned in.' : 'This assignment has not been turned in.'}</p>
                                <p>{event.graded ? 'This assignment has been graded. You got ' + event.grade + "%" : 'This assignment has not been graded.'}</p>
                            </div>
                        </div>
                    </div>
                </div>
